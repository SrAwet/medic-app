  ...
  return (
    ...
    <div className="max-w-md mx-auto md:max-w-2xl translate-y-6 ">
      {data.map(patient => (
            ...
            <div className="p-8">
                <div className="uppercase tracking-wide text-sm text-sky-500 font-semibold">Patient Name</div>
                <a className="block mt-1 text-lg leading-tight font-medium text-black hover:underline">{patient.name}</a>
